...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM registered WHERE username = ?";
...
<!-- Header -->
   <nav class="header">
    ...
    <ul>
	  ...
	  <li><a href="#">Cart</a></li>
	   <li><a href="login.php">Login/Register</a></li>
		<li>Contact: info@info@thewatchfacecompany.co.in</li>
    </ul>
  </nav>
	...
	<div class="inputs">
               ...
               <label for="username"><b><font size="4.5">Username</font></b></label>
