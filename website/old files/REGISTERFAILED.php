...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = $sql = "INSERT INTO registered (name, email, password, city, state, address, phoneno)
values ('$name','$email','$password','$city','$state','$address','$phoneno')";

         
        if($stmt = mysqli_prepare($link, $sql)){
            mysqli_stmt_bind_param($stmt, "ssssssi", $param_username, $param_password, $param_name, $param_city, $param_state, $param_address, $param_phoneno);
            echo "entering data";
